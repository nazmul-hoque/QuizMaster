...
/* harmony import */ var _quiz_quiz_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./quiz/quiz.component */ "./src/app/home/quiz/quiz.component.ts");
/* harmony import */ var _quiz_result_quiz_result_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./quiz-result/quiz-result.component */ "./src/app/home/quiz-result/quiz-result.component.ts");
...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'quizresult', component: _quiz_result_quiz_result_component__WEBPACK_IMPORTED_MODULE_5__["QuizResultComponent"] }
        ]
    }
];
...
module.exports = "<div class=\"container-fluid\">\n  <div class=\"col-md-12\">\n    Welcome to Online Quiz Master\n    <p class=\"lead\">\n      <button type=\"button\" class=\"btn btn-success\" [routerLink]=\"['quiz']\">Start Quiz</button>\n    </p>\n  </div>\n  <div class=\"card\">\n    <router-outlet></router-outlet>\n  </div>\n</div>"
...
/* harmony import */ var _quiz_quiz_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./quiz/quiz.component */ "./src/app/home/quiz/quiz.component.ts");
/* harmony import */ var _quiz_result_quiz_result_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./quiz-result/quiz-result.component */ "./src/app/home/quiz-result/quiz-result.component.ts");
...
var HomeModule = /** @class */ (function () {
    ...
    HomeModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"], _quiz_quiz_component__WEBPACK_IMPORTED_MODULE_6__["QuizComponent"], _quiz_result_quiz_result_component__WEBPACK_IMPORTED_MODULE_7__["QuizResultComponent"]],
            imports: [
...
/***/ "./src/app/home/quiz-result/quiz-result.component.css":
/*!************************************************************!*\
  !*** ./src/app/home/quiz-result/quiz-result.component.css ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2hvbWUvcXVpei1yZXN1bHQvcXVpei1yZXN1bHQuY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/home/quiz-result/quiz-result.component.html":
/*!*************************************************************!*\
  !*** ./src/app/home/quiz-result/quiz-result.component.html ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"card\"> <!-- *ngIf=\"showResult === true\"> -->\n  <div class=\"card-header\">\n    Result Summary\n  </div>\n  <div class=\"card-body\">\n    Score : {{Count}} <span>Out Of</span> {{quizProvider.QCount.length}}\n  </div>\n  <div *ngFor=\"let answer of quizProvider.Result\" class=\"card-body\">\n    <div>\n      Question: {{answer.Question}}\n    </div>\n    <div class=\"col-md-12\">\n      Correct Result: ({{answer.CorrectAnswer}}), Your Answer: {{answer.Answer}}, Status:\n      <div *ngIf=\"answer.AnswerStatus === true\" class=\"text-success\" style=\"display: inline-block\">\n        {{answer.AnswerStatus}}\n      </div>\n      <div *ngIf=\"answer.AnswerStatus === false\" class=\"text-danger\" style=\"display: inline-block\">\n        {{answer.AnswerStatus}}\n      </div>\n    </div>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/home/quiz-result/quiz-result.component.ts":
/*!***********************************************************!*\
  !*** ./src/app/home/quiz-result/quiz-result.component.ts ***!
  \***********************************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_shared_provider_quiz_answer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/shared/provider/quiz-answer */ "./src/app/shared/provider/quiz-answer.ts");



var QuizResultComponent = /** @class */ (function () {
    function QuizResultComponent(quizProvider) {
        this.quizProvider = quizProvider;
        this.Count = 0;
        this.Count = quizProvider.Result.filter(function (item) { return item.AnswerStatus === true; }).length;
    }
    ...
    QuizResultComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./quiz-result.component.html */ "./src/app/home/quiz-result/quiz-result.component.html"),
            styles: [__webpack_require__(/*! ./quiz-result.component.css */ "./src/app/home/quiz-result/quiz-result.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_shared_provider_quiz_answer__WEBPACK_IMPORTED_MODULE_2__["QuizAnswerProvider"]])
    ], QuizResultComponent);
...
module.exports = "button {\r\n  margin: 10px;\r\n}\r\n\r\nul {\r\n  list-style: none;\r\n}\r\n\r\nli>input {\r\n    margin-right: 5px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<div class=\"card\">\n  <div class=\"card-header\">Select correct answer for the below question.</div>\n  <div class=\"card-body\">\n    <div>{{questions[currentPosition].Question}}</div>\n    <div>\n      <ul *ngFor=\"let questionOption of questions[currentPosition].Option\">\n        <li>\n          <input type=\"radio\" name=\"question\" value=\"{{questionOption}}\"\n            (change)=\"selectAnswer($event)\">{{questionOption}}\n        </li>\n      </ul>\n    </div>\n  </div>\n  <div class=\"alert alert-warning alert-dismissible fade show\" role=\"alert\" *ngIf=\"showResult === true\">\n    <strong>Please Select any option...</strong>\n  </div>\n  <div class=\"card-footer\">\n    <button class=\"btn btn-primary\" *ngIf=\"currentPosition>0\" (click)=\"showPrevious()\"><i\n        class=\"fa fa-arrow-left\"></i>Previous</button>\n    <button class=\"btn btn-success\" (click)=\"goToNextQuestion()\">Submit</button>\n    <button class=\"btn btn-primary\" *ngIf=\"currentPosition <= arrayLength - 1\" (click)=\"showNext()\">Next<i\n        class=\"fa fa-arrow-right\"></i></button>\n  </div>\n</div>\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var src_app_shared_provider_quiz_answer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/provider/quiz-answer */ "./src/app/shared/provider/quiz-answer.ts");




var QuizComponent = /** @class */ (function () {
    function QuizComponent(router, activatedRoute, quizProvider) {
        this.router = router;
    ...
    QuizComponent.prototype.showPrevious = function () {
        if (this.currentPosition > 0) {
            this.currentPosition = this.currentPosition - 1;
        }
    };
    QuizComponent.prototype.showNext = function () {
        if (this.currentPosition < this.arrayLength - 1) {
            this.currentPosition = this.currentPosition + 1;
        }
    };
    QuizComponent.prototype.selectAnswer = function (event) {
        if (event.srcElement.value !== undefined) {
            this.selectedAnswer = event.srcElement.value;
        }
    };
    QuizComponent.prototype.goToNextQuestion = function () {
        var _this = this;
        if (this.selectedAnswer !== undefined) {
            this.showResult = false;
            var filterdArray = this.quizAnswer.filter(function (element) { return element.QuestionId === _this.questions[_this.currentPosition].QuestionId; });
    ...
    QuizComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], src_app_shared_provider_quiz_answer__WEBPACK_IMPORTED_MODULE_3__["QuizAnswerProvider"]])
    ], QuizComponent);
